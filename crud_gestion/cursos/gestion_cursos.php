...
$sql = "SELECT id_curso, nombres FROM cursos ORDER BY id_curso ASC";
                ...
                <table id="tabla-alumnos">
                    ...
                    <tbody id="tbody-alumnos">
                        <?php if ($resultado && $resultado->num_rows > 0): ?>
                            ...
                            <tr data-id="<?= htmlspecialchars($row['id_curso']) ?>">
                                <td class="cell-checkbox"><input type="checkbox" class="row-checkbox" data-id="<?= $row['id_curso'] ?>"></td>
                                <td class="cell-id"><?= $row['id_curso'] ?></td>
