...
<div class="cuerpo">
    <main class="login-container">
        ...
        <p><strong>Saludos Alumno</strong><br>
        Por favor inicie sesión para acceder a nuestro Sistema Educativo</p>
        </div>

        <form class="login-box" action="./crud/inicio_sesion_alumno.php" method="POST">
            <h2>Iniciar sesión para alumnos</h2>

            <div class="input-group">
                <label for="dni">DNI</label>
                <input type="text" id="dni" placeholder="Ingrese su DNI" name="DNI" required>
            </div>
